...
public class SearchAnomalyResultsTool implements Tool {
    ...
    // TODO: update everything below to use AD instead of alerting monitors.

    // Response is currently in a simple string format including the list of anomaly results, and
    // total number of results. The output will likely need to be updated, standardized, and include more fields in the
